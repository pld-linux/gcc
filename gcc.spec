...
%define		_snap	20070530
Release:	0.%{_snap}.1
Epoch:		6
License:	GPL v2+
Group:		Development/Languages
#Source0:	ftp://gcc.gnu.org/pub/gcc/releases/gcc-%{version}/%{name}-%{version}.tar.bz2
Source0:	ftp://gcc.gnu.org/pub/gcc/snapshots/%{_major_ver}-%{_snap}/gcc-%{_major_ver}-%{_snap}.tar.bz2
# Source0-md5:	a41e97d912d63f737bb2edd11f48f333
